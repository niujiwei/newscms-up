	...
	<form action="" id="signform">
		...
		<fieldset>
			<table class="tableclass" style="display: none;" id="signtable">
				<tr>
					<td><font color="red" style="margin-right:10px">*</font>签收人：</td>
					<td class="td2"><input class="" type="text"
						name="sign_user" id="sign_user" class="validate[required]"/></td>
							<td><font color="red" style="margin-right:10px">*</font>签收人证件：</td>
				...
				<td>签收代理人：</td>
					<td class="td2"><input type="text" name="sign_name"
						id="sign_name" /></td>
							<td><span style="color: red"></span>签收代理人证件：</td>
